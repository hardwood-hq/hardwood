...
# aad_prefix is set but store_aad_prefix=False,
# so the prefix is NOT stored in the file — reader must supply it via AadPrefixProvider
...
pq.write_table(
    data,
    "parquet-testing-runner/src/test/resources/encryption/encrypt_columns_footer_aad_prefix_supplied.parquet",
