...
| `DictionarySpacePredicateBenchmark` | Packed, eager, and lazy binary predicate evaluation across cold/hot, sparse/full, short/long, and EQ/LT/IN shapes (#859) | self-generating |
