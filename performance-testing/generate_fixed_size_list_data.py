...
# price). k=4 is the bit-packed regime, k=768 the RLE interior, and k=9/k=15 the
# scalar fallback (9..15 is not a byte-aligned per-record stride; k=15 the worst).
# Every real Parquet
