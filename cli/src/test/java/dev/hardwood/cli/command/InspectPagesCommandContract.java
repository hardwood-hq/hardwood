...
interface InspectPagesCommandContract {
    ...
    default void enrichesOutputWithPageIndex() {
        ...
        assertThat(result.output()).isEqualTo("""
                ...
                | RG | Page  | Type    | Encoding | First Row | Compressed | Values | Min  | Max  | Nulls |
                +----+-------+---------+----------+-----------+------------+--------+------+------+-------+
                |  0 |     0 | DATA_V2 |    PLAIN |         0 |    8.0 KiB |  1,024 |    0 | 1023 |     0 |
                |    |     1 | DATA_V2 |    PLAIN |     1,024 |    8.0 KiB |  1,024 | 1024 | 2047 |     0 |
                |    |     2 | DATA_V2 |    PLAIN |     2,048 |    8.0 KiB |  1,024 | 2048 | 3071 |     0 |
                |    |     3 | DATA_V2 |    PLAIN |     3,072 |    8.0 KiB |  1,024 | 3072 | 4095 |     0 |
                |    |     4 | DATA_V2 |    PLAIN |     4,096 |    8.0 KiB |  1,024 | 4096 | 5119 |     0 |
                |    |     5 | DATA_V2 |    PLAIN |     5,120 |    8.0 KiB |  1,024 | 5120 | 6143 |     0 |
                |    |     6 | DATA_V2 |    PLAIN |     6,144 |    8.0 KiB |  1,024 | 6144 | 7167 |     0 |
                |    |     7 | DATA_V2 |    PLAIN |     7,168 |    8.0 KiB |  1,024 | 7168 | 8191 |     0 |
                |    |     8 | DATA_V2 |    PLAIN |     8,192 |    8.0 KiB |  1,024 | 8192 | 9215 |     0 |
                |    |     9 | DATA_V2 |    PLAIN |     9,216 |    6.1 KiB |    784 | 9216 | 9999 |     0 |
                +====+=======+=========+==========+===========+============+========+======+======+=======+
                |    | Total |         |          |           |   78.1 KiB | 10,000 |      |      |     0 |
                +----+-------+---------+----------+-----------+------------+--------+------+------+-------+""");
    }
