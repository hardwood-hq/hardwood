...
/// [IntGtBatchMatcher] for a column annotated `INT(32, isSigned = false)`, whose values order by
...
public final class UnsignedIntGtBatchMatcher implements IntBatchMatcher {

    private static final int BIAS = Integer.MIN_VALUE;

    private final int biasedLiteral;

    public UnsignedIntGtBatchMatcher(int literal) {
