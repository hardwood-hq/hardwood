...
/// [LongGtEqBatchMatcher] for a column annotated `INT(64, isSigned = false)`, whose values order by
...
public final class UnsignedLongGtEqBatchMatcher implements LongBatchMatcher {

    private static final long BIAS = Long.MIN_VALUE;

    private final long biasedLiteral;

    public UnsignedLongGtEqBatchMatcher(long literal) {
