...
///  Reader for AesGcmCtrV1 from Thrift Compact Protocol.
public class AesGcmCtrV1Reader {

    public static AesGcmCtrV1 read(ThriftCompactReader reader) throws IOException {
    ...
    private static AesGcmCtrV1 readInternal(ThriftCompactReader reader) throws IOException {
        byte[] aadPrefix = null;
