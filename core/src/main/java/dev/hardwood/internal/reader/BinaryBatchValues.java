...
public final class BinaryBatchValues {
    ...
    /// entry IDs. Set once at batch allocation; unlike [#internStrings], this
    ...
    /// dictionary path, since otherwise both consumers read [#bytes]. The first
    /// dictionary page switches the batch on (see [#ensureDictionary]).
