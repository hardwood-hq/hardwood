 ...
 * work polymorphically with both {@link dev.hardwood.reader.RowReader} (a stateful,
 * mutable view over the current row) and {@link PqStruct} (an immutable, self-contained
 * nested struct value).
 * </p>
 *
 * @see PqStruct
