...
public final class ColumnWriter {
    ...
    ///
    /// Any exception fails the writer, whether the batch is rejected, its `filler` throws, or it
    /// cannot be written: the writer accepts no more data, and [ParquetFileWriter#close()]
    /// discards the output.
    ///
