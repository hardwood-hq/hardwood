...
1. **Strict-reader interop gate (primary)**: hardwood writes a file, parquet-java reads
   ...
   already lives. Settled in [WRITER_INTEROP_GATE.md](../_designs/WRITER_INTEROP_GATE.md).
