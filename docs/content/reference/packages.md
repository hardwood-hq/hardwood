...
| [`dev.hardwood.writer`](/api/latest/dev/hardwood/writer/package-summary.html) | **Public API** | Parquet file writing: `ParquetFileWriter` with its columnar (`ColumnBatch`) and row-oriented (`RowWriter`) APIs, and `WriterConfig`. |
